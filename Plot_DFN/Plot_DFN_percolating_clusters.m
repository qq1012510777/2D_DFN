function f = Plot_DFN_percolating_clusters(Domain_coordinates, Cluster, Frac, Percoalting_cluster)
    ...
    for jk = 1:size(Percoalting_cluster, 2)

        i = Percoalting_cluster(jk);
